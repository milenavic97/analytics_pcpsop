...
// ─────────────────────────────────────────────────────────────
// Autenticação: anexa o token da sessão em toda chamada à API
// ─────────────────────────────────────────────────────────────
// O backend agora exige um token válido (Authorization: Bearer <token>)
// em praticamente todas as rotas. Esta função busca o token da sessão
// atual do Supabase Auth para anexar automaticamente nas chamadas.
