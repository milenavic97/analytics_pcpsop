    ...
    <>
      ...
      {!open && (
        <button
          ...
          className="fixed left-[72px] bottom-6 z-[999] flex h-11 w-11 items-center justify-center rounded-full shadow-lg transition-all hover:scale-[1.05]"
          style={{
            background: "#1B3A5C",
            color: "#FFFFFF",
          }}
      ...
      {open && !minimized && (
        <div
          className="fixed left-[72px] bottom-6 z-[999] flex h-[620px] w-[420px] flex-col overflow-hidden rounded-2xl border shadow-2xl"
          style={{
            background: "#FFFFFF",
            borderColor:
              "var(--border)",
